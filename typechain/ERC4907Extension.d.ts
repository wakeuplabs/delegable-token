...
interface ERC4907ExtensionInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC4907Extension extends BaseContract {
  ...
  interface: ERC4907ExtensionInterface;
